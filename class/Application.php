...
class Application {
    ...
    public function add_completed_project($data, $img) {
        $sql = "INSERT INTO tbl_completed_project (project_name, address, land_area, land_position, city, project_location, label, no_of_apertment, apertment_size, description, no_of_lift, lift_capacity, generator, started_date, ended_date, image, construction_status, viedo_link,map)"
                . "VALUES ('$data[project_name]', '$data[address]', '$data[land_area]' ,'$data[land_position]','$data[city]','$data[project_location]', '$data[label]', '$data[no_of_apertment]','$data[apertment_size]','$data[description]','$data[no_of_lift]','$data[lift_capacity]','$data[generator]','$data[started_date]','$data[ended_date]','$img','$data[construction_status]','$data[viedo_link]','$data[map]')";
        if (mysqli_query($this->db_connect, $sql)) {
            ...
            $sql = "INSERT INTO tbl_project_floorplans(poject_category, project_name, img1, img2, img3, img4, img5, img6, img7, img8, img9, img10, img11, img12) 
                VALUES('tbl_completed_project','$data[project_name]','','','','','','','','','','','','')";

            mysqli_query($this->db_connect, $sql);

            $sql = "INSERT INTO tbl_constructions(project_category, project_name,status, img1, img2, img3) 
                VALUES('tbl_completed_project','$data[project_name]','','','','')";
    ...
    public function add_ongoing_project($data, $img) {
        $sql = "INSERT INTO tbl_ongoing_project (project_name, address, land_area, land_position, city, project_location, label, no_of_apertment, apertment_size, description, no_of_lift, lift_capacity, generator, started_date, ended_date, image, construction_status, viedo_link,map)"
                . "VALUES ('$data[project_name]', '$data[address]', '$data[land_area]' ,'$data[land_position]','$data[city]','$data[project_location]', '$data[label]', '$data[no_of_apertment]','$data[apertment_size]','$data[description]','$data[no_of_lift]','$data[lift_capacity]','$data[generator]','$data[started_date]','$data[ended_date]','$img','$data[construction_status]','$data[viedo_link]','$data[map]')";
        if (mysqli_query($this->db_connect, $sql)) {
            $message = 'ongoing project successfully added';
            $sql = "INSERT INTO tbl_project_floorplans(poject_category, project_name, img1, img2, img3, img4, img5, img6, img7, img8, img9, img10, img11, img12) 
                VALUES('tbl_ongoing_project','$data[project_name]','','','','','','','','','','','','')";
            //     echo '<pre>'.$sql.'</pre>';
            mysqli_query($this->db_connect, $sql);
    ...
    public function add_upcoming_project($data, $img) {
        $sql = "INSERT INTO tbl_upcoming_project (project_name, address, land_area, land_position, city, project_location, label, no_of_apertment, apertment_size, description, no_of_lift, lift_capacity, generator, started_date, ended_date, image, construction_status, viedo_link,map)"
                . "VALUES ('$data[project_name]', '$data[address]', '$data[land_area]' ,'$data[land_position]','$data[city]','$data[project_location]', '$data[label]', '$data[no_of_apertment]','$data[apertment_size]','$data[description]','$data[no_of_lift]','$data[lift_capacity]','$data[generator]','$data[started_date]','$data[ended_date]','$img','$data[construction_status]','$data[viedo_link]','$data[map]')";
        if (mysqli_query($this->db_connect, $sql)) {
            $message = 'Upcoming project successfully added';
            $sql = "INSERT INTO tbl_project_floorplans(poject_category, project_name, img1, img2, img3, img4, img5, img6, img7, img8, img9, img10, img11, img12) 
                VALUES('tbl_upcoming_project','$data[project_name]','','','','','','','','','','','','')";
            mysqli_query($this->db_connect, $sql);
    ...
    public function select_single_project_construction($project_name, $project_category) {
        $sql = "SELECT * FROM tbl_constructions WHERE project_name='$project_name' and project_category='$project_category'";
        // echo '<br><br><br><br><br><br><br><br><br><br><pre>'. $sql . '</pre>';
        if (mysqli_query($this->db_connect, $sql)) {
            $query_result = mysqli_query($this->db_connect, $sql);
            return $query_result;
    ...
    //update_single_project_construction_info

    public function update_single_project_construction_info($data, $col, $value) {
        $sql = "UPDATE tbl_constructions SET  $col='$value' where project_category='$data[category]' and project_name='$data[project_name]' ";
        if (mysqli_query($this->db_connect, $sql)) {
    ...
    public function insert_single_floorplan_info($data, $col, $img) {
        $sql = "UPDATE tbl_project_floorplans SET $col='$img' where poject_category='$data[category]' and project_name='$data[project_name]'";
        //echo '<pre><h1><br><br><br><br>'.$sql.'</h1></pre>';
        if (mysqli_query($this->db_connect, $sql)) {
            $message = 'Image Uploaded Successfully';
            return $message;
        } else {
