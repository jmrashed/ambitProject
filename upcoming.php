    ...
    <div class="row subaboutus">
        ...
        <div class="col-md-3">
            <div class="list-group">
                <a href="upcoming.php" class="list-group-item active">UPCOMING</a>
                ...
                <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 240px; width: 720px; height: 480px; overflow: hidden;">
                    <?php while ($upcoming_info = mysqli_fetch_assoc($quiry_result)) { ?>
                        <div data-p="150.00" style="display: none;">
                            ...
                            <a href="singleproject.php?id=<?= $upcoming_info['id']; ?>&category=tbl_upcoming_project"> 
                            <img data-u="image" src="images/<?= $upcoming_info['image']; ?>" class="img img-responsive" style="width:100%;margin-right:10px; padding-right:5px;" />  </a>
    ...
    <div class="row subaboutus">
        ...
        <div class="text-center aboutus">
            ...
            <form class="form-inline" action="ongoing.php" method="post">
                ...
                // $conn= mysqli_connect("127.0.0.1", "ambitbd_root", "S]67U+c};-bR@mWB", "ambitbd_realstate");
                    $sql = "SELECT DISTINCT  city FROM tbl_upcoming_project";
                ...
                <select name="location" class="form-control">
                    <?php
                    $sql = "SELECT DISTINCT  project_location FROM tbl_upcoming_project";
                    $result = $conn->query($sql);
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ?>
        ...
        <div class="row">
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <div class="col-md-4">
                        ...
                        <a href="singleproject.php?id=<?= $row['ongoing_project_id']; ?>&category=tbl_ongoing_project"> 
        ...
        while ($upcoming_info = mysqli_fetch_assoc($quiry_result)) {
            ...
            <div class="col-md-3">
                ...
                <a href="singleproject.php?id=<?= $upcoming_info['id']; ?>&category=tbl_upcoming_project">
                    <img class="img img-responsive img-thumbnail" src="images/<?php echo $upcoming_info['image']; ?>"></a>
            </div> 
<?php } ?>
