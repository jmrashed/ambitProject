    ...
    <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 240px; width: 720px; height: 480px; overflow: hidden;">
        <?php for ($i = 1; $i <= 12; $i++) { ?>
            <div data-p="150.00" style="display: none;">
                <?php if ($i < 10) { ?>                          
                    <a href="singleproject.php?id=<?= $i; ?>"> <img data-u="image" src="images/0<?= $i; ?>.jpg" />  </a>
                    <img data-u="thumb" src="images/thumb-0<?= $i; ?>.jpg" />   
                <?php } else { ?>
                    <a href="singleproject.php?id=<?= $i; ?>"> <img data-u="image" src="images/<?= $i; ?>.jpg" />  </a>
                    <img data-u="thumb" src="images/thumb-<?= $i; ?>.jpg" />   
                <?php } ?>
            </div> 
        <?php } ?>
