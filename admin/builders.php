...
$quiry_result = $obj_application->select_concern_info('tbl_builders');
...
if (isset($_POST['update'])) {
    ...
    $obj_application->update_concern_info($_POST, 'tbl_builders', $_FILES['file']['name']);
}
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="row"> 
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="builders.php" enctype="multipart/form-data" method="post">
