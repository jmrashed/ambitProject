...
if (isset($_POST['btn'])) {
    ...
    $message = $obj_application->add_completed_project($_POST,$_FILES['image']['name']);
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content"> 
                           <?php
                            ...
                            ?> 
                              <label class="label label-primary col-md-12" for="last-name"><h5>Add Completed Project</h5>  </label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea   id="ckeditor " name="apertment_size"  class="form-control "></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
