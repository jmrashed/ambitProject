...
if (isset($_POST['btn'])) {
    ...
    $message = $obj_application->add_ongoing_project($_POST, $_FILES['image']['name']);
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content"> 
                        ...
                        ?> 
                        <label class="label label-primary col-md-12" for="last-name"><h5>Add Ongoing Project</h5>  </label>
