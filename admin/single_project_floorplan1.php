...
//    echo '</pre>';
    ...
    $im10 = $_FILES['file10']['name'];
    $im11 = $_FILES['file11']['name'];
    $im12 = $_FILES['file12']['name'];
    $obj_application->insert_single_floorplan_info($_POST, $im1, $im2, $im3, $im4, $im5, $im6, $im7, $im8, $im9, $im10, $im11, $im12);
                            ...
                            <div class="x_panel">
                                ...
                                <div class="row"> 
                                    ...
                                    if (isset($_GET['SetSlider'])) {
                                        ...
                                        <form id="demo-form2" enctype="multipart/form-data" method="post" class="form-horizontal form-label-left" action="single_project_floorplan.php" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <input type="file" id="last-name" name="file10"  class="form-control col-md-7 col-xs-12"> 
                                                    <input type="file" id="last-name" name="file11"  class="form-control col-md-7 col-xs-12">
                                                    <input type="file" id="last-name" name="file12"  class="form-control col-md-7 col-xs-12"> 
